...
public class tab1_ph extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        XYSeries tempSeries = new SimpleXYSeries(ph, SimpleXYSeries.ArrayFormat.Y_VALS_ONLY, "ph Series");
        LineAndPointFormatter phFormat = new LineAndPointFormatter(Color.BLUE, null, null, null);
